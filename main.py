...
def update_user_data(username: str, first_name: str, last_name: str, email: str, password: str):
    user_file_name = USERS_BASE_DIR + username + ".json"
...
# testes
# create user
print(create_user("default_username", "default_first_name", "default_last_name", "default_email", "default_password"))
# list users
print(list_users())
# update user data
print(update_user_data("default_username", "default_first_name1", "default_last_name1", "default_email1", "default_password1"))
# delete user
